...
<body style="background-color: #5800FF;">
    <div class="container-xl">
        <div class="row d-flex justify-content-center" id="margin-row">
            <div class="col-10 d-flex justify-content-center align-items-center bg-black text-info" id="container-box"> <!-- top-50 start-50 translate-middle -->
                        ...
                        <div class="anagrafe">
                            ...
                            <div class="anagInput col-12 d-flex justify-content-around text-center align-middle mt-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control anagInpN rounded-pill border border-3 border-info" type="text" id="nome" name="nome" aria-describedby="name" placeholder="Nome">
